...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=8259554403218070&notebook=%2F00-SDP-Introduction&demo_name=pipeline-bike&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fpipeline-bike%2F00-SDP-Introduction&version=1&user_hash=dcfe6d3ff1610ad3a7fa730d5111adca8da4e061f092de3b66814981eb18d338">
...
# MAGIC
# MAGIC
# MAGIC **Your Spark Declarative Pipelines has been installed and started for you!** Open the <a dbdemos-pipeline-id="pipeline-bike" href="#joblist/pipelines/25143395-e5c3-4077-9614-674c25913024" target="_blank">Bike Rental Declarative Pipeline</a> to see it in action.<br/>
...
# MAGIC   <tr>
# MAGIC     <td>
# MAGIC     <a dbdemos-dashboard-id="bike-rental" href='/sql/dashboardsv3/01f0fc0a5478171abc650610db83565f' target="_blank">Business Dasbhoard</a>
# MAGIC     </td>
# MAGIC     <td>
# MAGIC     - <a  dbdemos-dashboard-id="data-quality" href='/sql/dashboardsv3/01f0fc0a5478171abc650610db83565f' target="_blank">Bike Rental Data Monitoring Dashboard</a>
# MAGIC     <br/>
# MAGIC     - <a dbdemos-dashboard-id="operational" href='/sql/dashboardsv3/01f0fc0a5478171abc650610db83565f' target="_blank">Bike Rental Pipeline Operational Dashboard</a>
# MAGIC     </td>
# MAGIC   </tr>
# MAGIC   <tr>
