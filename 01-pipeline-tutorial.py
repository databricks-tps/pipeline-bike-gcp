...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=8259554403218070&notebook=%2F01-pipeline-tutorial&demo_name=pipeline-bike&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fpipeline-bike%2F01-pipeline-tutorial&version=1&user_hash=dcfe6d3ff1610ad3a7fa730d5111adca8da4e061f092de3b66814981eb18d338">
...
# MAGIC from
# MAGIC   fevm_gcp_tps.dbdemos_pipeline_bike.maintenance_logs_raw
# MAGIC limit 10
...
# MAGIC You have everything you need! Once ready, open your <a  dbdemos-dashboard-id="bike-rental" href='/sql/dashboardsv3/01f0fc0a5478171abc650610db83565f' target="_blank">Bike Rental Business Dashboard</a> to track all your insights in realtime ! 
# MAGIC
# MAGIC
