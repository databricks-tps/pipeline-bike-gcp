...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=8259554403218070&notebook=%2F1-sdp-sql%2Fexplorations%2F02-Pipeline-event-monitoring&demo_name=pipeline-bike&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fpipeline-bike%2F1-sdp-sql%2Fexplorations%2F02-Pipeline-event-monitoring&version=1&user_hash=dcfe6d3ff1610ad3a7fa730d5111adca8da4e061f092de3b66814981eb18d338">
# MAGIC
...
# MAGIC   *
# MAGIC FROM
# MAGIC   fevm_gcp_tps.dbdemos_pipeline_bike.pipeline_bike_event_logs
# MAGIC limit 10
...
# MAGIC FROM fevm_gcp_tps.dbdemos_pipeline_bike.pipeline_bike_event_logs
...
# MAGIC from
# MAGIC   fevm_gcp_tps.dbdemos_pipeline_bike.pipeline_bike_event_logs e,
...
# MAGIC
# MAGIC - Open the <a  dbdemos-dashboard-id="data-quality" href='/sql/dashboardsv3/01f0fc0a55e2178791a9d7fe7da9dbdd' target="_blank">Bike Rental Data Monitoring Dashboard</a> to track all your data quality, and add alerts based on your requirements.
# MAGIC - Open the <a  dbdemos-dashboard-id="operational" href='/sql/dashboardsv3/01f0fc0a55521612a4bb6c4dfa84c0b5' target="_blank">Bike Rental Operational Pipeline Dashboard</a> to track all your pipeline event and cost!