...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=8259554403218070&notebook=%2F1-sdp-sql%2Fexplorations%2F01-Exploring-the-Data&demo_name=pipeline-bike&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fpipeline-bike%2F1-sdp-sql%2Fexplorations%2F01-Exploring-the-Data&version=1&user_hash=dcfe6d3ff1610ad3a7fa730d5111adca8da4e061f092de3b66814981eb18d338">

# COMMAND ----------

import os

raw_data_volume = "/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/"
...
# MAGIC %sql
# MAGIC select * from read_files("/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/maintenance_logs/*.csv", format => "csv") limit 10
...
# MAGIC %sql
# MAGIC select * from read_files("/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/maintenance_logs/*.csv", format => "csv", multiline => true)
...
# MAGIC %sql
# MAGIC select * from read_files("/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/rides/*.csv", format => "csv") limit 10

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from read_files("/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/weather/*.json", format => "json") limit 10

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from read_files("/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/customers_cdc/*.parquet", format => "parquet") limit 10
...
# MAGIC from read_files("/Volumes/fevm_gcp_tps/dbdemos_pipeline_bike/raw_data/customers_cdc/*.parquet", format => "parquet") 
